...
class OptimalControlProblem(object):
    ...
    def g(self, x_k, u_k):
        ...
        rhs_s_y_p = - beta_y_p * s_y_p * i_v + (r_y_1 + u_1) * l_y_p + (r_y_2 + u_2) * i_y_p+ (r_a + u_3 )* i_a_p - alpha * s_y_p
        rhs_s_a_p = - beta_a_p * s_a_p * i_v + alpha * s_y_p
        rhs_l_y_p = beta_y_p * s_y_p * i_v - b_y * l_y_p - (r_y_1 + u_1) * l_y_p
    ...
    def lambda_function(self, x_k, u_k, lambda_k):
        ...
        rhs_l_5 = A_2 + (r_y_2 + u_2) * (lambda_1 - lambda_5) + beta_y_v * s_v * (lambda_8 - lambda_7)

        rhs_l_6 = A_3 + (r_a + u_3) * (lambda_1 - lambda_6) + beta_a_v * s_v * (lambda_8 - lambda_7)

        rhs_l_7 = (beta_y_v * i_y_p + beta_a_v * i_a_p) * (lambda_8 - lambda_7) - (gamma + u_4) * lambda_7

        rhs_l_8 = A_4 + beta_y_p * s_y_p * (lambda_3 - lambda_1) + beta_a_p * s_a_p * (lambda_4 - lambda_2) - (gamma + u_4) * lambda_8
