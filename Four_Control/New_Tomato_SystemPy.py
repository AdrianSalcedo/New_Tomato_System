...
'''y_odeint_zero = np.array([s_y_p_zero, s_a_p_zero, l_y_p_zero, l_a_p_zero, i_y_p_zero, i_a_p_zero, s_v_zero, i_v_zero])
...
plt.figure()
plt.plot(t,x_wc_1[:,0], label="young susceptible")
plt.plot(t,x_wc_1[:,1], label="adult susceptible")
plt.plot(t,x_wc_1[:,2], label="young latent")
plt.plot(t,x_wc_1[:,3], label="adult latent")
plt.plot(t,x_wc_1[:,4], label="young infected")
plt.plot(t,x_wc_1[:,5], label="adult infected")
...
plt.figure()
plt.plot(t,x_wc_1[:,6], label="vector susceptible")
plt.plot(t,x_wc_1[:,7], label="vector infected")
plt.xlabel(r'Time(days)')
